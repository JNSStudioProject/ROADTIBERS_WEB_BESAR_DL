  ...
  return (
    <div className="rt-bright-stage relative min-h-screen flex items-center justify-center overflow-hidden px-4 py-12">
      ...
      <div className="w-full max-w-lg z-10">
        <MotionSection direction="up" delay={0.1} className="flex flex-col items-center text-center mb-8 gap-4">
        ...
        <MotionSection direction="up" delay={0.3} className="mt-8 text-center">
